"""Main analysis pipeline for furniture survey data."""
...
from .data_cleaning import FurnitureDataCleaner
import sys
...
def run_analysis_pipeline(show_plots: bool = False):
    ...
    try:
        ...
        print("Starting furniture market analysis...")
        
        # Initialize analyzers
        data_cleaner = FurnitureDataCleaner()
